...
public final class Constants {
    ...
    public static final boolean isTestnet = Sbr.getBooleanProperty("sbr.isTestnet");
    public static final boolean isOffline = Sbr.getBooleanProperty("sbr.isOffline");
    public static final boolean isLightClient = Sbr.getBooleanProperty("sbr.isLightClient");
    public static final String customLoginWarning = Sbr.getStringProperty("sbr.customLoginWarning", null, false, "UTF-8");

    public static final String COIN_SYMBOL = "SBR";
    public static final String ACCOUNT_PREFIX = "SBR";
    public static final String PROJECT_NAME  = "SucataCoin";
    public static final int MAX_NUMBER_OF_TRANSACTIONS = Sbr.getIntProperty("sbr.maxNumberOfTransactions", 255);
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_SBR = 1000000000;
    public static final long ONE_SBR = 100000000;
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_SBR * ONE_SBR;

    public static final int BLOCK_TIME = 60;
    public static final long INITIAL_BASE_TARGET = BigInteger.valueOf(2).pow(63).divide(BigInteger.valueOf(BLOCK_TIME * MAX_BALANCE_SBR)).longValue(); //153722867;
    public static final long MAX_BASE_TARGET = INITIAL_BASE_TARGET * (isTestnet ? MAX_BALANCE_SBR : 50);
    ...
    public static final int MAX_ROLLBACK = Math.max(Sbr.getIntProperty("sbr.maxRollback"), 720);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Sbr.getIntProperty("sbr.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? Sbr.getIntProperty("sbr.testnetLeasingDelay", 1440) : 1440;
    public static final long MIN_FORGING_BALANCE_NQT = 1000 * ONE_SBR;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = Sbr.getIntProperty("sbr.forgingDelay");
    public static final int FORGING_SPEEDUP = Sbr.getIntProperty("sbr.forgingSpeedup");
    public static final int BATCH_COMMIT_SIZE = Sbr.getIntProperty("sbr.batchCommitSize", Integer.MAX_VALUE);
    ...
    static {
        int maxPrunableLifetime = Sbr.getIntProperty("sbr.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = Sbr.getBooleanProperty("sbr.includeExpiredPrunable");
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_SBR;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_SBR;

    public static final boolean correctInvalidFees = Sbr.getBooleanProperty("sbr.correctInvalidFees");
