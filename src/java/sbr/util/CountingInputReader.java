...
import sbr.SbrException.SbrIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  SbrIOException      Maximum count exceeded
     */
    private void incCount(long c) throws SbrIOException {
        count += c;
        if (count > limit)
            throw new SbrIOException("Maximum size exceeded: " + count);
    }
}
