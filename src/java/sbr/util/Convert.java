...
public final class Convert {
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws SbrException.NotValidException {
        if (numBytes > getMaxStringSize(maxLength)) {
            throw new SbrException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseSBR(String sbr) {
        return parseStringFraction(sbr, 8, Constants.MAX_BALANCE_SBR);
    }
