...
import sbr.Sbr;
import sbr.env.service.SbrService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/sbr.manifest.mf", Sbr.class.getCanonicalName(), "./lib");
        String serviceClassName = SbrService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/sbrservice.manifest.mf", serviceClassName, "./lib");
    }
