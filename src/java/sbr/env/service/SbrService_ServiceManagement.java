...
package sbr.env.service;

import sbr.Sbr;
import sbr.env.LookAndFeel;

import javax.swing.*;

@SuppressWarnings("UnusedDeclaration")
public class SbrService_ServiceManagement {
    ...
    public static String[] serviceGetInfo() {
        return new String[]{
                Sbr.APPLICATION + " Server", // Long name
                "Manages the " + Sbr.APPLICATION + " cryptographic currency protocol", // Description
                "true", // IsAutomatic
                "true", // IsAcceptStop
                "", // failure exe
                "", // args failure
    ...
    public static boolean serviceIsCreate() {
        return JOptionPane.showConfirmDialog(null, "Do you want to install the " + Sbr.APPLICATION + " service ?", "Create Service", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }
    ...
    public static boolean serviceIsDelete() {
        return JOptionPane.showConfirmDialog(null, "This " + Sbr.APPLICATION + " service is already installed. Do you want to delete it ?", "Delete Service", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }
