...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws SbrException.NotValidException;

        Transaction build(String secretPhrase) throws SbrException.NotValidException;
    ...
    void validate() throws SbrException.ValidationException;
