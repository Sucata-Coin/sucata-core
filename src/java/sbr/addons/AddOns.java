...
import sbr.Sbr;
import sbr.http.APIServlet;
import sbr.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        Sbr.getStringListProperty("sbr.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Sbr.getBooleanProperty("sbr.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Sbr.isDesktopApplicationEnabled() ? "sbrdesktop.policy" : "sbr.policy");
