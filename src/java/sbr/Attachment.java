...
import sbr.util.bbh.LengthRwPrimitiveType;
import sbr.util.bbh.StringRw;
...
import static sbr.util.bbh.LengthRwPrimitiveType.BYTE;
import static sbr.util.bbh.LengthRwPrimitiveType.SHORT;
...
public interface Attachment extends Appendix {
    ...
    abstract class AbstractAttachment extends Appendix.AbstractAppendix implements Attachment {
        ...
        @Override
        final void validate(Transaction transaction) throws SbrException.ValidationException {
        ...
        final int getFinishValidationHeight(Transaction transaction) {
            return isPhased(transaction) ? transaction.getPhasing().getFinishHeight() - 1 : Sbr.getBlockchain().getHeight();
        }
    ...
    final class MessagingAliasAssignment extends AbstractAttachment {
        ...
        MessagingAliasAssignment(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
    ...
    final class MessagingAliasSell extends AbstractAttachment {
        ...
        MessagingAliasSell(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
    ...
    final class MessagingAliasBuy extends AbstractAttachment {
        ...
        MessagingAliasBuy(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
            this.aliasName = MessagingAliasAssignment.ALIAS_NAME_RW.readFromBuffer(buffer);
        }
    ...
    final class MessagingAliasDelete extends AbstractAttachment {
        ...
        MessagingAliasDelete(final ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
            this.aliasName = MessagingAliasAssignment.ALIAS_NAME_RW.readFromBuffer(buffer);
        }
    ...
    final class MessagingPollCreation extends AbstractAttachment {
        ...
        MessagingPollCreation(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
            ...
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new SbrException.NotValidException("Invalid number of poll options: " + numberOfOptions);
            }
    ...
    final class MessagingVoteCasting extends AbstractAttachment {
        ...
        public MessagingVoteCasting(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
            pollId = buffer.getLong();
            int numberOfOptions = buffer.get();
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new SbrException.NotValidException("More than " + Constants.MAX_POLL_OPTION_COUNT + " options in a vote");
            }
    ...
    final class MessagingPhasingVoteCasting extends AbstractAttachment {
        ...
        MessagingPhasingVoteCasting(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
            ...
            if (secretLength > Constants.MAX_PHASING_REVEALED_SECRET_LENGTH) {
                throw new SbrException.NotValidException("Invalid revealed secret length " + secretLength);
            }
            if (secretLength > 0) {
    ...
    final class MessagingAccountInfo extends AbstractAttachment {
        ...
        MessagingAccountInfo(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
    ...
    final class MessagingAccountProperty extends AbstractAttachment {
        ...
        MessagingAccountProperty(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
    ...
    final class ColoredCoinsAssetIssuance extends AbstractAttachment {
        ...
        ColoredCoinsAssetIssuance(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
            this.name = NAME_RW.readFromBuffer(buffer);
            this.description = DESCRIPTION_RW.readFromBuffer(buffer);
    ...
    final class ColoredCoinsAssetTransfer extends AbstractAttachment {
        ...
        ColoredCoinsAssetTransfer(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
    ...
    final class DigitalGoodsListing extends AbstractAttachment {
        ...
        DigitalGoodsListing(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
    ...
    class DigitalGoodsDelivery extends AbstractAttachment {
        ...
        DigitalGoodsDelivery(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
    ...
    final class UnencryptedDigitalGoodsDelivery extends DigitalGoodsDelivery implements Encryptable {
        ...
        void putMyBytes(ByteBuffer buffer) {
            if (getGoods() == null) {
                throw new SbrException.NotYetEncryptedException("Goods not yet encrypted");
            }
    ...
    final class MonetarySystemCurrencyIssuance extends AbstractAttachment {
        ...
        MonetarySystemCurrencyIssuance(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
            this.name = NAME_RW.readFromBuffer(buffer);
    ...
    final class ShufflingRecipients extends AbstractShufflingAttachment {
        ...
        ShufflingRecipients(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count < 0) {
                throw new SbrException.NotValidException("Invalid data count " + count);
            }
    ...
    final class ShufflingCancellation extends AbstractShufflingAttachment {
        ...
        ShufflingCancellation(ByteBuffer buffer) throws SbrException.NotValidException {
            super(buffer);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new SbrException.NotValidException("Invalid data count " + count);
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (size > Constants.MAX_PAYLOAD_LENGTH) {
                    throw new SbrException.NotValidException("Invalid data size " + size);
                }
            ...
            count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new SbrException.NotValidException("Invalid keySeeds count " + count);
            }
    ...
    final class TaggedDataUpload extends TaggedDataAttachment {
        ...
        public TaggedDataUpload(String name, String description, String tags, String type, String channel, boolean isText,
                                String filename, byte[] data) throws SbrException.NotValidException {
            ...
            if (isText && !Arrays.equals(data, Convert.toBytes(Convert.toString(data)))) {
                throw new SbrException.NotValidException("Data is not UTF-8 text");
            }
        }
