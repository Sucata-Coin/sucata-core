...
import sbr.TransactionScheduler;
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws SbrException {
        ...
        try {
            ...
            if (transactionBytes == null && transactionJSON == null) {
                ...
                transaction = Sbr.newTransactionBuilder((JSONObject) response.get("transactionJSON")).build();
            } else {
            ...
            try {
                ...
                try (DbIterator<? extends Transaction> unconfirmedTransactions = Sbr.getTransactionProcessor().getAllUnconfirmedTransactions()) {
