 ...
 * account ledger tracks all account changes as determined by the sbr.ledgerAccounts,
 * sbr.ledgerLogUnconfirmed and sbr.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than sbr.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the sbr.maxAPIRecords property
 ...
 *     <tr>
 *       <td>SBR_BALANCE</td>
 *       <td>Change in the SBR balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_SBR_BALANCE</td>
 *       <td>Change in the unconfirmed SBR balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  SbrException        Invalid request
     */
    @Override
