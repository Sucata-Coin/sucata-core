...
import sbr.Currency;
import sbr.CurrencyBuyOffer;
import sbr.CurrencySellOffer;
...
import static sbr.http.JSONResponses.*;
...
public final class ParameterParser {
    ...
    public static int getNumberOfConfirmations(HttpServletRequest req) throws ParameterException {
        return getInt(req, "numberOfConfirmations", 0, Sbr.getBlockchain().getHeight(), false);
    }
    ...
    public static long getHoldingId(HttpServletRequest req, HoldingType holdingType) throws ParameterException {
        long holdingId = ParameterParser.getUnsignedLong(req, "holding", holdingType != HoldingType.SBR);
        if (holdingType == HoldingType.SBR && holdingId != 0) {
    ...
    public static Transaction.Builder parseTransaction(String transactionJSON, String transactionBytes, String prunableAttachmentJSON) throws ParameterException {
        ...
        if (transactionJSON != null) {
            try {
                ...
                return Sbr.newTransactionBuilder(json);
            } catch (SbrException.ValidationException | RuntimeException | ParseException e) {
            ...
            try {
                ...
                return Sbr.newTransactionBuilder(bytes, prunableAttachments);
            } catch (SbrException.ValidationException|RuntimeException | ParseException e) {
                Logger.logDebugMessage(e.getMessage(), e);
                JSONObject response = new JSONObject();
    ...
    public static Attachment.TaggedDataUpload getTaggedData(HttpServletRequest req) throws ParameterException, SbrException.NotValidException {
