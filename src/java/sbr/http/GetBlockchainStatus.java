...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", Sbr.APPLICATION);
        response.put("version", Sbr.VERSION);
        response.put("time", Sbr.getEpochTime());
        ...
        response.put("currentMinRollbackHeight", Sbr.getBlockchainProcessor().getMinRollbackHeight());
