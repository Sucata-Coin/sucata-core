...
import static sbr.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static sbr.http.JSONResponses.UNKNOWN_ACCOUNT;
import static sbr.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer SBR, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * SBR amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  SbrException        Unable to process request
     */
    @Override
