...
/**
 * Issue a currency on the SBR blockchain
 * <p>
 * A currency is the basic block of the SBR Monetary System it can be exchanged with SBR, transferred between accounts,
 ...
 * For {@link sbr.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum SBR value per unit to allow the currency to become active
 * For {@link sbr.CurrencyType#RESERVABLE} currency
 ...
 * For {@link sbr.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link sbr.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link sbr.crypto.HashFunction algorithm} used for minting.
 * For {@link sbr.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link sbr.CurrencyType#EXCHANGEABLE} nor {@link sbr.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link sbr.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link sbr.CurrencyType#RESERVABLE} becomes active, in case it is {@link sbr.CurrencyType#CLAIMABLE} the SBR used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link sbr.CurrencyType#RESERVABLE} becomes active, in case it is non {@link sbr.CurrencyType#CLAIMABLE} the SBR used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link sbr.CurrencyType#MINTABLE} currency, the number of units per {@link sbr.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link sbr.http.CurrencyMint}<br>
 * </ul>
 *
 * @see sbr.CurrencyType
 * @see sbr.crypto.HashFunction
 */
