...
### Database ###
  ...
  - main database: `sbr_db/`
  - test database: `sbr_test_db/`
  ...
  - use the sbr.db framework when accessing the database from your code
...
- https://crowdin.com/project/sbr-ui-translation
...
The SBR wallet UI run as a mobile app.
...
6. Under the <SBRRoot>\mobile\app folder execute the command:
createapp.bat
