...
public class JPLSnapshotTest extends BlockchainTest {
    ...
    private static final String INPUT_JSON_STR =
            "{\n" +
            "    \"balances\": {\n" +
            "        \"SBR-NZKH-MZRE-2CTT-98NPZ\": 30000000000000000,\n" +
            "        \"SBR-X5JH-TJKJ-DVGC-5T2V8\": 30000000000000000,\n" +
            "        \"SBR-LTR8-GMHB-YG56-4NWSE\": 30000000000000000\n" +
            "    },\n" +
            "    \"publicKeys\": [\n" +
    ...
    public void testSnapshotWithoutInput() {
        ...
        Assert.assertTrue(total > Constants.MAX_BALANCE_NQT - 100000 * Constants.ONE_SBR); // some funds were sent to genesis or are locked in claimable currency
    }
    ...
    public void testSnapshotWithInput() {
        ...
        Assert.assertTrue(BigInteger.valueOf(aliceCurrentBalance).divide(BigInteger.valueOf(10)).subtract(BigInteger.valueOf(aliceSnapshotBalance)).longValueExact() < Constants.ONE_SBR);
