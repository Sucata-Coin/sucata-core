...
package sbr.http.twophased;

import sbr.BlockchainTest;
import sbr.Constants;
import sbr.Sbr;
import sbr.http.APICall;
import sbr.http.twophased.TestCreateTwoPhased.TwoPhasedMoneyTransferBuilder;
...
public class TestApproveTransaction extends BlockchainTest {
    ...
    public void validVoteCasting() {
        ...
        APICall apiCall = new TwoPhasedMoneyTransferBuilder()
                .finishHeight(Sbr.getBlockchain().getHeight() + duration)
                .build();
        ...
        Assert.assertEquals(-50 * Constants.ONE_SBR - 2 * Constants.ONE_SBR, ALICE.getBalanceDiff());
        Assert.assertEquals(50 * Constants.ONE_SBR, BOB.getBalanceDiff());
    ...
    public void invalidVoteCasting() {
        ...
        Assert.assertEquals("ALICE balance: ", -2 * Constants.ONE_SBR, ALICE.getBalanceDiff());
    ...
    public void sendMoneyPhasedNoVoting() {
        ...
        Assert.assertEquals(-100 * Constants.ONE_SBR - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
        ...
        // Sender
        Assert.assertEquals(-100 * Constants.ONE_SBR - fee, ALICE.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_SBR - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
