...
public class SendMoneyTest extends BlockchainTest {
    ...
    public void sendMoney() {
        JSONObject response = new APICall.Builder("sendMoney").
                ...
                param("amountNQT", 100 * Constants.ONE_SBR).
                param("feeNQT", Constants.ONE_SBR).
                build().invoke();
        ...
        Assert.assertEquals(-100 * Constants.ONE_SBR - Constants.ONE_SBR, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
        Assert.assertEquals(0, BOB.getBalanceDiff());
        Assert.assertEquals(0, BOB.getUnconfirmedBalanceDiff());
        generateBlock();
        // Forger
        Assert.assertEquals(Constants.ONE_SBR, FORGY.getBalanceDiff());
        Assert.assertEquals(Constants.ONE_SBR, FORGY.getUnconfirmedBalanceDiff());
        // Sender
        Assert.assertEquals(-100 * Constants.ONE_SBR - Constants.ONE_SBR, ALICE.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_SBR - Constants.ONE_SBR, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
        Assert.assertEquals(100 * Constants.ONE_SBR, BOB.getBalanceDiff());
        Assert.assertEquals(100 * Constants.ONE_SBR, BOB.getUnconfirmedBalanceDiff());
    }
    ...
    public void sendAndReturn() {
        ...
        // Recipient
        Assert.assertEquals(0, BOB.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_SBR - Constants.ONE_SBR, BOB.getUnconfirmedBalanceDiff());
        generateBlock();
        // Forger
