...
public class FastForgingTest extends AbstractForgingTest {
    ...
    public void fastForgingTest() {
        ...
        properties.setProperty("sbr.disableGenerateBlocksThread", "false");
        properties.setProperty("sbr.enableFakeForging", "false");
        properties.setProperty("sbr.timeMultiplier", "1000");
