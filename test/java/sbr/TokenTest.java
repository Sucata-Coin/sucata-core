...
public class TokenTest extends BlockchainTest {
    ...
    public void testParseValidToken() throws Exception {
        ...
        Token actual = Token.parseToken(token, "http://sbr.org");
    ...
    public void testGenerateToken() throws Exception {
        ...
        String tokenString = Token.generateToken("secret", "http://sbr.org");
        int end = Sbr.getEpochTime();
        Token token = Token.parseToken(tokenString, "http://sbr.org");
    ...
    public void emptySecret() throws Exception {
        String tokenString = Token.generateToken("", "http://sbr.org");
        Token token = Token.parseToken(tokenString, "http://sbr.org");
        assertTrue(token.isValid());
    }
