...
import static sbr.installer.ConfigHandler.Setting;
import static sbr.installer.ConfigHandler.VAR_CLEAN_INSTALL_DIR;
import static sbr.installer.ConfigHandler.VAR_FILE_CONTENTS;
import static sbr.installer.ConfigHandler.VAR_SHUTDOWN_SERVER;
...
public class ConfigConsolePanel extends AbstractConsolePanel
{
    ...
    public boolean run(InstallData installData, Console console) {
        ...
        if (handler.isSbrInstallDir(installPath) &&
        ...
        if (! allSettings.isEmpty() &&
            askUser("There are a few settings that can be customized now. " +
                    "They will be put into conf/sbr.properties file which you can edit later.",
