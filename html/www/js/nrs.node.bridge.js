const options = {
    url: "http://localhost:6876", // URL of SBR remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the SBR client wasn't designed with modularity in mind therefore we need
            ...
            // Now load some SBR specific libraries into the global scope
            global.SbrAddress = require('./util/sbraddress');
            ...
            // however the SBR client relies on a global browser scope which defines the NRS object
