...
var NRS = (function(NRS, $) {
	var DOWNLOAD_REPOSITORY_URL = "https://bitbucket.org/Jelurida/sbr/downloads/";
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "sbr-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "sbr-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "sbr-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "sbr-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "sbr-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "sbr-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "sbr-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "sbr-client-", ext: "sh"}
	];
