...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount SBR",
			labelI18n: "amount_sbr",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumSBR",
			addonText: "SBR",
			addonI18n: "sbr_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_sbr', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceSBR';
		context['addonText'] = 'SBR';
		context['addonI18n'] = 'sbr_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_sbr', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
